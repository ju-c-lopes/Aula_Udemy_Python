...
utiliza-se __ duplo undescore no início do seu nome.
...
# print(user._Acesso__email)  # Temos acesso. Mas não deveríamos fazer este acesso. (Name Mangling)
user.mostra_senha()
...
# p1 = Produto('Playstatuin 4', 'Video Game', 2300)
...
class Produto:
    ...
    def __init__(self, nome, descricao, valor):
        ...
        Produto.contador = self.id  # na próxima instância, contador será a atualização daqui
...
print(p1.imposto)       # Acesso incorreto do atributo de classe
