...
# disponíveis (ficarão na memória). Caso você saiba quais funções
# você precisa utilizar deste módulo, então esta não seria a forma
# ideal de utilização. Nós veremos uma forma melhor na Forma 2;

print(random.random())

# Veja que para utilizar a função random() do pacote random, nós
# colocamos o nome do pacote e o nome da função separados por ponto
