...
Como módulos Python nada mais são do que arquivos Python, então, todos os programas
ou todos os arquivos que criamos neste curso são módulos Python prontos para serem
utilizados.
