...
OBS: Sobre dicionários
    -> Chave e valor são separados por dois pontos :  ex: 'chave:valor';
...
# Caso o get não encontre o objeto com a chave informada, será retornado o valor None e não será gerado Key Error
...
# Tuplas por exemplo são bastatnte interessantes de serem utilizadas como chaves de dicionários,
# pois as mesmas são imutáveis.

localidades = {
    (35.6895, 39.6917): 'Escritório em Tókio',
    (41.7128, 74.0060): 'Escritório em Nova York',
...
# del receita['fev']  # OBS Se a chave não existir, será gerado um KeyError
# OBS: Neste caso o valor removido não é retornado.

# Imagine um comércio eletrônico, onde temos um carrinho de compras na qual adicionamos produtos.
"""
# Carrinho de Compras:
#     Produto 1:
#         - nome;
...
# Desta forma, facilmente adicionamos ou removemos produtos no carrinho e em cada produto podemos
...
# Ele vai gerar para cada valor do iterável uma chave e irá atribuir a esta chava o valor informado
