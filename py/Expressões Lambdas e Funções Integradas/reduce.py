...
Guido van Rossum (criador do Python) disse: Utilize a função reduce() se você realmente precisa dela.
...
A função reduce(), funciona da seguinte forma:
    ...
    Passo 2: res2 = f(res1, a3) # Apica a função passando o resultado do passo1 mais o terceiro elemento
...
Ou seja, em cada passo ela aplica a função passando como primeiro argumento da aplicação anterior.
...
dados = [2, 3, 4, 5, 7, 11, 13, 19, 17, 23, 29]
