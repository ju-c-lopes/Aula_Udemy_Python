...
História -> Erro em um programa nos anos 50 onde uma mariposa pousou sobre as
válvulas do computador que ocupava uma sala inteira, e prejudicou a saída
de dados, então eles tiveram que retirar o inseto(bug) pra fazer o primeiro
debug
...
# Costumamos realizar todos os imports de bibliotecas
# no início do arquivo. Por isso, ao invés de colocarmos
# o import do pdb no inicio do arquivo, nós colocamos
# somente onde vamos debuggar, e ao finalizar já
# fazemos a remoção
...
# pdb, pois o comando de debug foi incorporado como função built-in
# (integrada) chamada breakpoint()
...
# utilizar o comando p para imprimir as variáveis. Ou seja: p nome_da_variável
